...
class Schools(object):
    ...
    def load_school_data(self):
        ...
        if self.new_schools:
            school_df = pd.read_csv("Zone_Generation/Zone_Data/schools_table_for_zone_development_updated.csv")
        else:
    ...
    def _load_capacity(self, school_df):
        # add on capacity
        programs = pd.read_csv("Zone_Generation/Zone_Data/stanford_capacities_12.23.21.csv")
        programs.rename(
            columns={
                "SchNum": "school_id",
